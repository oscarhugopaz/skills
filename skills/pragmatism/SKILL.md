---
name: pragmatism
description: Guides durable engineering judgment for software design, implementation, refactoring, and review. Use when making coding decisions, choosing scope, evaluating trade-offs, simplifying code, or deciding how much change a problem deserves.
---
# Pragmatism

Pragmatism is disciplined judgment under real constraints. Build what solves the problem, fits the system, and remains understandable after you leave.

## Start With Reality

Understand the actual problem before changing code.
Read the surrounding system until the change has a clear home.
Prefer evidence from code, behavior, tests, logs, and users over assumptions.
...
Do not optimize for the request as written when the request misunderstands the problem.

## Respect The Existing System

Treat the codebase as a living argument made by previous decisions.
Follow established conventions unless they are actively causing harm.
...
Avoid novelty that future maintainers must decode without benefit.

## Prefer The Smallest Complete Change

Make the smallest change that fully solves the problem.
Small does not mean partial. Complete the behavior, preserve the invariants, and leave the system coherent.
...
Do not confuse cleverness with leverage.

## Own What You Add

Treat every dependency, flag, setting, public surface, and extension point as future maintenance.
Add a dependency only when it solves a problem better than the platform, the standard library, or the codebase already can.
...
Choose the simple robust option over the simple fragile option.
...
Leave the system easier to change in the direction it is already moving.
...
Make future work discoverable without making it part of today.
...
Do not let tests become a second implementation of speculation.
